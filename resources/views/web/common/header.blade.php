    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
            <ul class="navbar-nav text-uppercase mx-auto">
                <li class="nav-item">
                    <a class="nav-link @yield('movies')" href="{{ url('/phims') }}">@lang('lang.sortby_movies')</a>
                </li>
                <li class="nav-item mx-2">
                    <a class="nav-link @yield('schedules')" href="{{ url('/lichtheophim') }}">@lang('lang.sortby_schedules')</a>
                </li>
                <li class="nav-item mx-2">
                    <a class="nav-link @yield('events')" href="{{ url('/events') }}">@lang('lang.news_events')</a>
                </li>
                <li class="nav-item mx-2">
                    <a class="nav-link @yield('support')" href="{{ url('/contact') }}">@lang('lang.contact')/@lang('lang.support')</a>
                </li>
            ...
            @if(Auth::check())
                <div class="nav-item dropdown mx-2">
                    ...
                    <ul class="dropdown-menu shadow" style="background-color: #2e292e">
                        ...
                        <li><a class="dropdown-item link-light" href="/dangxuat">@lang('lang.signout')</a></li>
                    </ul>
                </div>
            @else
        ...
        <ul class="dropdown-menu shadow dropdown-menu-end" style="background-color: #f5f5f5">
            ...
            <li>
                <a class="dropdown-item" href="{{ url('lang/cn') }}">
                    <img class="rounded me-1" style="max-width: 30px" src="images/language/china.png" alt="vietnamese">
                    @lang('lang.cn')
                </a>
            </li>
        </ul>
